...
export default () => {
  ...
  const { data, accounts, contracts } = locations.state;
  const [nama, setNama] = useState(data.nama);
  const [lokasi, setLokasi] = useState(data.lokasi);
  const [kondisi, setKondisi] = useState(data.kondisi);
  const [kategori, setKategori] = useState(data.kategori);
  const [noReg, setNoReg] = useState(data.nomorRegistrasi);

  const onSubmit = async (event) => {
    event.preventDefault()
    console.log("Submitting...")
    await contracts.methods.ubahData(data.index, nama, lokasi, kondisi, kategori, noReg).send({ from: accounts })
    history.goBack()
  }
      ...
      <Container className="px-0">
        ...
        <Form onSubmit={onSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select required value={kategori} onChange={(e) => setKategori(e.target.value)}>
          ...
          <Form.Group className="mb-3">
            <Form.Label>Kode Aset (Opsional)</Form.Label>
            <Form.Control type="text" placeholder='Masukkan Kode Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Nama Aset</Form.Label>
            <Form.Control required type="text" value={nama} onChange={(e) => setNama(e.target.value)} placeholder='Masukkan Nama Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>No. Registrasi</Form.Label>
            <Form.Control required type="number" placeholder='Isikan No. Register' value={noReg} onChange={(e) => setNoReg(e.target.value.slice(0,4))}/>
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Merk/Type Aset (Opsional)</Form.Label>
            <Form.Control type="text" placeholder='Masukkan Merk/Type Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Tahun Pembelian (Opsional)</Form.Label>
            <Form.Control type="text" placeholder='Isikan Tahun Pembelian' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Lokasi</Form.Label>
            <Form.Control required type="text" value={lokasi} onChange={(e) => setLokasi(e.target.value)} placeholder='Masukkan lokasi Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Jumlah Aset (Opsional)</Form.Label>
            <Form.Control type="text" placeholder='Masukkan Jumlah Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Kondisi Aset</Form.Label>
            <Form.Control required type="text" value={kondisi} onChange={(e) => setKondisi(e.target.value)} placeholder='Masukkan Kondisi Aset' />
            {/* <Form.Control.Feedback type="invalid">Masukkan Kode Aset</Form.Control.Feedback> */}
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Foto (Opsional)</Form.Label>
            <Form.Control type="file" />
          </Form.Group>
          &nbsp;
          <Button type="submit" variant="success" className="m-1">Simpan</Button>
