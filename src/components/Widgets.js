...
import Profile1 from "../assets/img/team/elyas.jpeg";
  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        ...
        <Card.Title>Elyas Bangapadang Musu</Card.Title>
        <Card.Subtitle className="fw-normal">Senior Software Engineer</Card.Subtitle>
        <Card.Text className="text-gray mb-4">JL. Haji Bau No.6, Kunjung Mae, Kec. Mariso, Kota Makassar</Card.Text>
      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          <Col xl={5} className="text-xl-center d-flex align-items-center justify-content-xl-center mb-3 mb-xl-0">
            <div className={`icon icon-shape icon-xl icon-${iconColor} rounded me-4 me-sm-0`}>
