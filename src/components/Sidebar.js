...
import ReactHero from "../assets/img/technologies/logo1.png";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Asset BPS" link={Routes.DashboardOverview.path} image={ReactHero} />
              <NavItem title="Dashboard" link={Routes.DashboardOverview.path} icon={faChartPie} />
              {cookies.role == "admin" ? (<NavItem title="Transactions" icon={faHandHoldingUsd} link={Routes.Transactions.path} />) : (<div></div>)}

              <NavItem title="Logout" icon={faSignOutAlt} link={Routes.Logout.path}/>
              {/* <NavItem title="Profile" icon={faUser} link={Routes.Settings.path} /> */}
              ...
              {/* <CollapsableNavItem eventKey="tables/" title="Menu Administrator" icon={faTable}>
                <NavItem title="Kategori Inventaris" link={Routes.BootstrapTables.path} />
              </CollapsableNavItem> */}
